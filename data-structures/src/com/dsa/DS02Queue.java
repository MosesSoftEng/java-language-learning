...
/**
 * DataStrucutures.Queue has a fixed size.
 * You can only add element at the rear of DataStrucutures.Queue - Enqueue
 * You can only remove element at the front of DataStrucutures.Queue - Dequeue
 */
class Queue {
    //* Fields
    ...
    public void enqueue(int i) {
        if(isFull()) {
            System.out.println("DataStrucutures.Queue is full");
            return;
        }
    ...
    public int peek() {
        if(isEmpty()) {
            System.out.println("DataStrucutures.Queue is empty");
            return -1;
        }
